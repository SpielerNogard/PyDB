...
Welcome to ``PyDB`` contributor's guide.
...
If you experience bugs or general issues with ``PyDB``, please have a look
...
You can help improve ``PyDB`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``PyDB`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``PyDB``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n PyDB python=3 six virtualenv pytest pytest-cov
    conda activate PyDB
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/PyDB.git
    cd PyDB
...
#. Install |pre-commit|_::
   ...
   ``PyDB`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/PyDB
.. _issue tracker: https://github.com/<USERNAME>/PyDB/issues
.. <-- end -->
